...
export function SummaryBlock({ narrative }: SummaryBlockProps) {
  return (
    <section className="mt-2">
      ...
      <div className="border-midnight from-cream-50 text-text shadow-narrative mt-1 rounded-[0_8px_8px_0] border-l-[3px] bg-linear-to-b to-white p-[20px_24px] font-sans text-[15px] leading-[1.7]">
